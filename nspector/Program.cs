...
namespace nspector
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                string csnPath = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), "Resources", "CustomSettingNames.xml");
                File.WriteAllText(csnPath, Properties.Resources.CustomSettingNames);
            }
            else
            {
