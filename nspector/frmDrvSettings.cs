...
namespace nspector
{
    ...
    public partial class frmDrvSettings : Form
    {
        ...
        private async Task ScanProfilesSilentAsync(bool scanPredefined, bool showProfileDialog)
        {
            ...
            if (scanPredefined && !_alreadyScannedForPredefinedSettings)
            {
                ...
                tscbShowScannedUnknownSettings.Checked = true;
                RefreshCurrentProfile();
            }
            else
            {
        ...
        private void LoadSettings()
        {
            ...
            tscbShowScannedUnknownSettings.Checked = settings.ShowScannedUnknownSettings;
        }
        ...
        private void lblApplications_Click(object sender, EventArgs e)
        {
